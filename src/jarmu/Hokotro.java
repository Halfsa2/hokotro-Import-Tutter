...
public class Hokotro extends IranyitottJarmu {
    ...
    public boolean lep(Csomopont celCsomopont) {
        ...
        if (this.varakozik > 0) {
            ...
            // Ideális esetben a hibaüzenetet a JatekVezerlo írja ki, de itt adjuk vissza a
            // false-t
            SkeletonLogger.exit(false);
            return false;
        }

        // 2. Topológiai validáció: szomszédos-e a célcsomópont? (Kivéve az első
        // lehelyezést)
        ...
        // Ha a befogad() false-t adott (pl. foglalt, vagy mély hó busznál), ide futunk
        // ki
        SkeletonLogger.exit(false);
        return false;
    }
